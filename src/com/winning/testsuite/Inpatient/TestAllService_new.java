...
import com.winning.testsuite.workflow.Inpatient.ServiceThread_new;
...
public class TestAllService_new extends InpatientTestBase {
    ...
    public static String reportFile = Framework.userDir + Framework.fileSeparator + "xtest" + Framework.fileSeparator + "住院单医嘱费用比对报告.html";
    ...
    public void test_01() throws InterruptedException {
        ...
        allServiceList = windbhis.getServiceList_new(reportTempFile, Data.retryFlag, Data.notRetryFlag);
...
//        pharmacyId = windb60.getOrgIdByOrgName(Data.WINEX_pharmacy_name, Data.WINEX_pharmacy_no);
